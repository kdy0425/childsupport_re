...
var Swiper = (function () {
    ...
    class ie {
      constructor() {
        ...
        const l = this;
        (l.__swiper__ = !0), (l.support = I()), (l.device = A({ userAgent: t.userAgent })), (l.browser = z()), (l.eventsListeners = {}), (l.eventsAnyListeners = []), (l.modules = [...l.__modules__]), t.modules && Array.isArray(t.modules) && l.modules.push(...t.modules);
        const o = {};
        l.modules.forEach((e) => {
    ...
    const ge = [
      ...
      function (e) {
        ...
        function M(e) {
          ...
          i >= 0 && (u[i] = e),
            u.length < 2 ||
              ((o = !0), (m.scaleMove = y()), m.imageEl && ((a.scale = (m.scaleMove / m.scaleStart) * c), a.scale > m.maxRatio && (a.scale = m.maxRatio - 1 + (a.scale - m.maxRatio + 1) ** 0.5), a.scale < s.minRatio && (a.scale = s.minRatio + 1 - (s.minRatio - a.scale + 1) ** 0.5), (m.imageEl.style.transform = `translate3d(0,0,0) scale(${a.scale})`)));
        }
        function C(e) {
          if (!S(e)) return;
